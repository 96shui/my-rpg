...
public class Crystal_Skill : Skill
{
    ...
    [SerializeField] private UI_SkillTreeSlot unlockCloneIsteadButton;
    ...
    [Header("Multi stacking crysttal")]
    ...
    protected override void Start()
    {
        ...
        unlockCloneIsteadButton.GetComponent<Button>().onClick.AddListener(UnlockCrystalMirage);
    ...
    {
        if(unlockCloneIsteadButton.unlocked)
